...
public class CreateInviteCodeRolesAdapter extends RecyclerView.Adapter<CreateInviteCodeRolesAdapter.RoleViewHolder> {

    private List<Role> rolesList = new ArrayList<>();

    public CreateInviteCodeRolesAdapter(List<Role> rolesList) {
        this.rolesList = rolesList;
    }

    @NonNull
    @Override
    public CreateInviteCodeRolesAdapter.RoleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
